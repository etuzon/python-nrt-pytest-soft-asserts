...
from nrt_pytest_soft_asserts.test.tests_suite import TestsSuite
...
def __replace_pyproject_version():
    ...
    for i, line in enumerate(file_lines):
        if line.startswith('version'):
            ...
            if version != nrt_pytest_soft_asserts.__version__:
                is_replace = True
                file_lines[i] = f"version='{nrt_pytest_soft_asserts.__version__}'"
